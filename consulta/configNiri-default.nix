# Traducción del default config de niri al formato de nix-wrapper-modules
# Fuente: https://github.com/niri-wm/niri/blob/main/resources/default-config.kdl
...
settings = {
  ...
  hotkey-overlay = {};  # presente pero vacío = comportamiento por defecto (mostrar al inicio)

  animations = {};  # presente pero vacío = animaciones por defecto activadas
  ...
  binds = {
    ...
    "Mod+O" = { repeat = false; toggle-overview = _: {}; };
    "Mod+Q" = { repeat = false; close-window = _: {}; };
    ...
    "Mod+WheelScrollDown"      = { cooldown-ms = 150; focus-workspace-down = _: {}; };
    "Mod+WheelScrollUp"        = { cooldown-ms = 150; focus-workspace-up = _: {}; };
    "Mod+Ctrl+WheelScrollDown" = { cooldown-ms = 150; move-column-to-workspace-down = _: {}; };
    "Mod+Ctrl+WheelScrollUp"   = { cooldown-ms = 150; move-column-to-workspace-up = _: {}; };
    ...
    "Mod+Escape" = { allow-inhibiting = false; toggle-keyboard-shortcuts-inhibit = _: {}; };
    "Mod+Shift+E".quit       = _: {};
